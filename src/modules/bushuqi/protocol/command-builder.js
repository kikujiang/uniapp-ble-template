...
export const buildReadDeviceStateCommand = () => buildFrame(`${FUNCTION_CODE.DEVICE_STATE}01`)

export const buildWriteDeviceStateCommand = (enabled) => {
  return buildFrame(`${FUNCTION_CODE.DEVICE_STATE}02${enabled ? '01' : '00'}`)
}
...
export const buildBootstrapCommands = () => {
  return [buildReadTimeCommand(), buildReadDeviceStateCommand(), buildQueryRecordSummaryCommand()]
}
